      ...
      <div className='w-full bg-primary py-8'>
        <div className='container text-center'>
          ...
          <div className='flex justify-around items-center gap-10 mx-auto'>
            <div className='flex flex-col gap-y-5 items-center w-[30%]'>
            ...
            {/* Input items */}
            <div className=' w-[45%]  px-4 py-16 rounded-2xl shadow-sm shadow-tertiary'>
              <from className='w-full flex flex-col gap-8'>
                ...
                <button type="submyt" className="bg-tertiary text-secondary block py-3 w-[30%] rounded-3xl hover:bg-secondary hover:text-tertiary hover:shadow transition-all"> Send Message </button>
              </from>
            </div>
          </div>
        </div>
