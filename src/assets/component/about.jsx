    ...
    <Element name='about-section'>
      <div className='w-full bg-[#E9DED3] '>
        <div className='container mx-auto text-center pt-10 text-[#0B1536]'>
          ...
          <p> my Intro</p>
          <div className='flex flex-col  md:flex-col lg:flex-row xl:flex-row 2xl:flex-row  gap-20 items-center mt-10 '>
            <div className='intro-left w-[100%] h-[100%] md:w-[75%] lg:w-[60%] xl:w-[60%] 2xl:w-[50%] '>
            ...
            <div className='intro-right text-left text-[#0B1536]'>
              <div className='flex gap-5 align-middle mb-8'>
                <div className='project w-[50%] md:w-[40%] lg:w-[25%] xl:w-[24%] 2xl:w-[34%] bg-[#E9DED3] rounded-xl hover:bg-[#E9E9E9] drop-shadow-md shadow-[#0B1536] text-center py-8'>
                  <p>
                    Completed <br />
                    10+ Projects
                  </p>
